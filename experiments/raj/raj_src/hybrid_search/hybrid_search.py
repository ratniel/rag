""" 
    This file contains the nodes which contains summary context in metadata. 
    Index Name for weaviate:- LlamaIndex_articles_context
"""
...
nodes = load_docs(
    path="/home/dai/33/project/rag/storage/docstore/article_nodes_embedded_combined",
    return_docstore=False,
)

vector_store = WeaviateVectorStore(
    weaviate_client=client, index_name="LlamaIndex_articles_context"
)

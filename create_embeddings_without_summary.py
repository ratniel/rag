...
dir_path = "./rag/data/text_data/Articles"
...
#         count += 1
# print(count)
nodes = embed_nodes(nodes=nodes, save_dir="./rag/Articles_store/docstore", docstore_name="Articles_with_embeddings_on_chunks", save_docstore=True)
